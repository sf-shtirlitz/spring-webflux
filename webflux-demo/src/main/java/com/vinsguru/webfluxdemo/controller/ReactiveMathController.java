...
public class ReactiveMathController {
    ...
    @GetMapping(value = "table/{input}/stream", produces = MediaType.TEXT_EVENT_STREAM_VALUE)//returns every result in
    // the Flux as soon as it becomes available on the server's side
